...
final class Version20211213111738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE domain_name (id INT AUTO_INCREMENT NOT NULL, server_id INT NOT NULL, url VARCHAR(255) NOT NULL, provider VARCHAR(255) NOT NULL, offer VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, invoiced_price DOUBLE PRECISION DEFAULT NULL, renewal_type VARCHAR(255) NOT NULL, renewal_date DATE NOT NULL, INDEX IDX_F3FF53611844E6B7 (server_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE server (id INT AUTO_INCREMENT NOT NULL, provider VARCHAR(255) NOT NULL, offer VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, invoiced_price DOUBLE PRECISION DEFAULT NULL, renewal_type VARCHAR(255) NOT NULL, renewal_date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
